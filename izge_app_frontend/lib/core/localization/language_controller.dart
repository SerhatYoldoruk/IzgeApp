...
class LanguageController extends ChangeNotifier {
  ...
  static final Map<String, String> _trTranslations = {
    ...
    // Auto Swept UI Translations (TR)
    'İzge App': 'İzge App',
    'Erişilebilirlik Neden Önemli?': 'Erişilebilirlik Neden Önemli?',
    'Bağış ve Destek': 'Bağış ve Destek',
    'Uygulama Ayarları': 'Uygulama Ayarları',
    'Giriş yapılıyor...': 'Giriş yapılıyor...',
    'Şifrenizi giriniz': 'Şifrenizi giriniz',
    'İsminizi giriniz': 'İsminizi giriniz',
    'Şifrenizi tekrar giriniz': 'Şifrenizi tekrar giriniz',
    'Çocuğunuzun Adı': 'Çocuğunuzun Adı',
    'Doğum Tarihi (GG.AA.YYYY)': 'Doğum Tarihi (GG.AA.YYYY)',
    'KVKK Aydınlatma Metni': 'KVKK Aydınlatma Metni',
    'Kullanım Şartları': 'Kullanım Şartları',
    'Sorunuzun başlığı nedir?': 'Sorunuzun başlığı nedir?',
    'Sorunuzun detaylarını veya paylaşmak istediğiniz konuyu buraya yazabilirsiniz...': 'Sorunuzun detaylarını veya paylaşmak istediğiniz konuyu buraya yazabilirsiniz...',
    'Şikayet sebebinizi yazın...': 'Şikayet sebebinizi yazın...',
    'Bu ayki gözlemlerinizi yazabilirsiniz...': 'Bu ayki gözlemlerinizi yazabilirsiniz...',
    'Atölye': 'Atölye',
    'Etkinliğin amacı, hedef kitlesi ve beklentilerinizi detaylandırın...': 'Etkinliğin amacı, hedef kitlesi ve beklentilerinizi detaylandırın...',
    'Mekanlar yüklenirken hata oluştu: \$e': 'Mekanlar yüklenirken hata oluştu: \$e',
    'Konum alınamadı: \$e': 'Konum alınamadı: \$e',
    'Puanınız kaydedildi, teşekkürler!': 'Puanınız kaydedildi, teşekkürler!',
    'Gönder': 'Gönder',
    'Sessizleşin': 'Sessizleşin',
    'Uyaranları Azaltın': 'Uyaranları Azaltın',
    'Fiziksel Temastan Kaçının': 'Fiziksel Temastan Kaçının',
    'Güvende Tutun': 'Güvende Tutun',
    'Ses dosyası henüz yüklenmemiş: \$path': 'Ses dosyası henüz yüklenmemiş: \$path',
    'Topluluk & Yardım Ağı': 'Topluluk & Yardım Ağı',
    'Yıllık Genel Kurul Toplantısı': 'Yıllık Genel Kurul Toplantısı',
    'Gelecek İçin Fidan Dikim Etkinliğimiz': 'Gelecek İçin Fidan Dikim Etkinliğimiz',
    'Yeni Toplum Merkezi İnşaatı': 'Yeni Toplum Merkezi İnşaatı',
    'Paylaş': 'Paylaş',
    'Maksimum Büyüklük': 'Maksimum Büyüklük',
    'Google hesabınız başarıyla bağlandı.': 'Google hesabınız başarıyla bağlandı.',
    'Bağlantı Kesildi': 'Bağlantı Kesildi',
    'Google hesabınızın bağlantısı başarıyla kaldırıldı.': 'Google hesabınızın bağlantısı başarıyla kaldırıldı.',
    'Bağlantı Hatası': 'Bağlantı Hatası',
    'İşlem sırasında bir hata oluştu.': 'İşlem sırasında bir hata oluştu.',
    'PIN kilidi başarıyla kaldırıldı.': 'PIN kilidi başarıyla kaldırıldı.',
    'Apple ile Bağlan': 'Apple ile Bağlan',
    'Bağlı değil': 'Bağlı değil',
    'Apple hesabınız başarıyla bağlandı.': 'Apple hesabınız başarıyla bağlandı.',
    'Açılışta 4 haneli PIN sorulur': 'Açılışta 4 haneli PIN sorulur',
    'Son Giriş': 'Son Giriş',
    'PIN kilidi aktifleştirildi.': 'PIN kilidi aktifleştirildi.',
    'Doğrulama maili gönderildi.': 'Doğrulama maili gönderildi.',
    'Anlık Bildirimler': 'Anlık Bildirimler',
    'Aylık bülten ve özetler': 'Aylık bülten ve özetler',
    'Karanlık Tema': 'Karanlık Tema',
    'Sistem temasına uyumlu': 'Sistem temasına uyumlu',
    'Şifre ve Güvenlik': 'Şifre ve Güvenlik',
    'Uygulama Hakkında': 'Uygulama Hakkında',
    'Uygulama Çökmesi': 'Uygulama Çökmesi',
    'Donma / Takılma': 'Donma / Takılma',
    'Yanlış Veri Gösterimi': 'Yanlış Veri Gösterimi',
    'Hatayı nasıl ve nerede aldığınızı detaylıca açıklayın...': 'Hatayı nasıl ve nerede aldığınızı detaylıca açıklayın...',
    'Aylık bağışınız iptal edilmiştir.': 'Aylık bağışınız iptal edilmiştir.',
    'Lütfen şifre gereksinimlerini karşılayın!': 'Lütfen şifre gereksinimlerini karşılayın!',
    'Hata oluştu: \${e.toString()}': 'Hata oluştu: \${e.toString()}',
    'Fotoğraf Çek': 'Fotoğraf Çek',
    'Kameranızı kullanarak yeni bir fotoğraf çekin': 'Kameranızı kullanarak yeni bir fotoğraf çekin',
    'Galeriden Seç': 'Galeriden Seç',
    'Cihazınızdaki fotoğraflar arasından seçim yapın': 'Cihazınızdaki fotoğraflar arasından seçim yapın',
    'Mevcut Fotoğrafı Kaldır': 'Mevcut Fotoğrafı Kaldır',
    'Lütfen geçerli ödeme bilgileri girin': 'Lütfen geçerli ödeme bilgileri girin',
    'Bağış tutarı başarıyla güncellendi.': 'Bağış tutarı başarıyla güncellendi.',
    'Türkçe': 'Türkçe',
    'Bağlantı kesildi': 'Bağlantı kesildi',
    'Hesap bağlandı': 'Hesap bağlandı',
    'Bildirimler işaretlenirken hata oluştu: \$e': 'Bildirimler işaretlenirken hata oluştu: \$e',
    '1. Veri Sorumlusunun Kimliği': '1. Veri Sorumlusunun Kimliği',
    '2. İşlenen Kişisel Verileriniz': '2. İşlenen Kişisel Verileriniz',
    '3. İşlenme Amaçları': '3. İşlenme Amaçları',
    '4. Veri Aktarımı ve Bulut Güvenliği': '4. Veri Aktarımı ve Bulut Güvenliği',
    '5. İlgili Kişinin Hakları (KVKK Md. 11)': '5. İlgili Kişinin Hakları (KVKK Md. 11)',
    '6. İletişim': '6. İletişim',
    'Talep bulunamadı. Lütfen numaranızı kontrol edin.': 'Talep bulunamadı. Lütfen numaranızı kontrol edin.',
    'İşleniyor': 'İşleniyor',
    'İlaç Yardımı Başvurusu': 'İlaç Yardımı Başvurusu',
    'Evrak Güncelleme Talebi': 'Evrak Güncelleme Talebi',
    'Dosya seçilemedi: \$e': 'Dosya seçilemedi: \$e',
    'Talep Alındı': 'Talep Alındı',
    'İnceleniyor': 'İnceleniyor',
    'İncelendi': 'İncelendi',
    'Tamamlanıyor': 'Tamamlanıyor',
    'Talep numarası kopyalandı': 'Talep numarası kopyalandı',
    // Discover & Tools Screen (TR)
    'Keşfet & Araçlar': 'Keşfet & Araçlar',
    'İhtiyacınız olan tüm gelişim, destek ve eğitim araçları tek bir yerde.': 'İhtiyacınız olan tüm gelişim, destek ve eğitim araçları tek bir yerde.',
    'Bilimsel kriterlerle gelişim analizi.': 'Bilimsel kriterlerle gelişim analizi.',
    'Haklar Rehberi': 'Haklar Rehberi',
    'Yasal haklarınız ve izlemeniz gereken yollar.': 'Yasal haklarınız ve izlemeniz gereken yollar.',
    'Kriz Yönetim Asistanı': 'Kriz Yönetim Asistanı',
    'Meltdown anında görsel nefes ve ipuçları.': 'Meltdown anında görsel nefes ve ipuçları.',
};
  ...
  static final Map<String, String> _enTranslations = {
    ...
    'Topluluk':'Community',
    'İzge Çözüm Merkezi':'Izge Solution Center',
    'İhtiyacınız olan tüm gelişim, destek ve eğitim araçları tek bi yerde.':'Your one-stop solution for all your development, support, and educational tools.',
    'Mini Aktiviteler':'Mini Activities',
    'Oyunlar, zamanlayıcı ve günlük rutin takibi.': 'Games, timer and daily routine tracking.',
    'Gelişim Takibi':'Development Tracking',
    'Katıldın' : 'You Participated',
    'Cevabımı Gör':'See My Answer',
    

  
    // Auto Swept UI Translations (EN)
    'İzge App': 'İzge App',
    'Erişilebilirlik Neden Önemli?': 'Erişilebilirlik Neden Önemli?',
    'Bağış ve Destek': 'Donations & Support',
    ...
    'Çocuğunuzun Adı': 'Çocuğunuzun Adı',
    'Doğum Tarihi (GG.AA.YYYY)': 'Doğum Tarihi (GG.AA.YYYY)',
    'Engel/Tanı Durumu (örn: Otizm, Disleksi)': 'Engel/Tanı Durumu (örn: Otizm, Disleksi)',
    'KVKK Aydınlatma Metni': 'KVKK Aydınlatma Metni',
    'Kullanım Şartları': 'Kullanım Şartları',
    'Sorunuzun başlığı nedir?': 'Sorunuzun başlığı nedir?',
    'Sorunuzun detaylarını veya paylaşmak istediğiniz konuyu buraya yazabilirsiniz...': 'Sorunuzun detaylarını veya paylaşmak istediğiniz konuyu buraya yazabilirsiniz...',
    ...
    'Atölye': 'Atölye',
    'Etkinliğin amacı, hedef kitlesi ve beklentilerinizi detaylandırın...': 'Etkinliğin amacı, hedef kitlesi ve beklentilerinizi detaylandırın...',
    'Mekanlar yüklenirken hata oluştu: \$e': 'Error',
    'Konum alınamadı: \$e': 'Konum alınamadı: \$e',
    'Puanınız kaydedildi, teşekkürler!': 'Puanınız kaydedildi, teşekkürler!',
    'Gönder': 'Send',
    'Sessizleşin': 'Sessizleşin',
    ...
    'İşlem sırasında bir hata oluştu.': 'Error',
    'PIN kilidi başarıyla kaldırıldı.': 'PIN kilidi başarıyla kaldırıldı.',
    'Apple ile Bağlan': 'Apple ile Bağlan',
    'Bağlı değil': 'Bağlı değil',
    'Apple hesabınız başarıyla bağlandı.': 'Apple hesabınız başarıyla bağlandı.',
    ...
    'Bağlantı kesildi': 'Bağlantı kesildi',
    'Hesap bağlandı': 'Hesap bağlandı',
    'Bildirimler işaretlenirken hata oluştu: \$e': 'Error',
    '1. Veri Sorumlusunun Kimliği': '1. Veri Sorumlusunun Kimliği',
    '2. İşlenen Kişisel Verileriniz': '2. İşlenen Kişisel Verileriniz',
    '3. İşlenme Amaçları': '3. İşlenme Amaçları',
    '4. Veri Aktarımı ve Bulut Güvenliği': '4. Veri Aktarımı ve Bulut Güvenliği',
    ...
    'Tamamlanıyor': 'Tamamlanıyor',
    'Talep numarası kopyalandı': 'Talep numarası kopyalandı',
    // Discover & Tools Screen (EN)
    'Keşfet & Araçlar': 'Discover & Tools',
    'İhtiyacınız olan tüm gelişim, destek ve eğitim araçları tek bir yerde.': 'All the development, support and educational tools you need, in one place.',
    'Bilimsel kriterlerle gelişim analizi.': 'Development analysis with scientific criteria.',
    'Haklar Rehberi': 'Rights Guide',
    'Yasal haklarınız ve izlemeniz gereken yollar.': 'Your legal rights and the paths you should follow.',
    'Kriz Yönetim Asistanı': 'Crisis Management Assistant',
    'Meltdown anında görsel nefes ve ipuçları.': 'Visual breathing and tips during meltdown.',
  };
}
