        ...
        child: Column(
          ...
          children: [
            ...
            _EventListCard(
              month: 'HAZ',
              day: '12',
              title: 'Fizik Tedavi Semineri',
              details: 'Kültür Merkezi • 14:00',
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => const EventsScreen()));
              },
            ),
            ...
            _SurveyCard(
              ...
              description: 'Hizmet kalitemizi artırmamıza yardımcı olun.',
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => const SurveysScreen()));
              },
            ),
          ],
        ),
