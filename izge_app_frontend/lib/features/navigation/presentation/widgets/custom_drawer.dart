...
import 'package:izge_app_frontend/features/profile/presentation/pages/liked_content_screen.dart';
...
import 'package:izge_app_frontend/features/requests/presentation/pages/request_screen.dart' as izge_req;
  ...
  Future<Map<String, dynamic>> _fetchDrawerUserData() async {
    ...
    try {
      ...
      return _cachedUserData ??
          {'full_name': 'Kullanıcı', 'avatar_url': '', 'role': 'member'};
    }
  }
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    GestureDetector(
                                      onTap: () => LanguageController.instance
                                          .changeLanguage('tr'),
                                      child: Container(
                                        padding: const EdgeInsets.symmetric(
                                          horizontal: 12,
                                ...
                                children: [
                                  Expanded(
                                    child: ValueListenableBuilder<List<String>>(
                                      valueListenable:
                                          ActivityState.instance.likedIds,
                                  ...
                                  Expanded(
                                    child: ValueListenableBuilder<List<String>>(
                                      valueListenable:
                                          ActivityState.instance.savedIds,
                                      builder: (context, ids, _) {
                                        return _StatCard(
                                          icon: Icons.bookmark,
                                          count: ids.length.toString(),
                                          label: 'Kaydedilenler'.tr(),
                                          onTap: () {
                                            Navigator.push(
                                              context,
                                              MaterialPageRoute(
                                  ...
                                  Expanded(
                                    child: ValueListenableBuilder<int>(
                                      valueListenable:
                                          ActivityState.instance.eventsCount,
